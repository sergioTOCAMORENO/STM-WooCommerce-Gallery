function stmpili_funcion_crear_lightbox( fichero, ancho, alto, titulo, enlace, cierre, margenColor, margenGrosor, margenRedondeo, bordeColor, bordeGrosor, bordeRedondeo ) {
	...
	texto = '<div class="cierre" href="javascript:void(0)" onclick="document.getElementById(\'light\').style.display = \'none\';' + 
			' document.getElementById(\'fade\').style.display = \'none\';"><span class="icon-cancel-circled"></span></div>' +
